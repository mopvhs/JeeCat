...
/**
 * maoche_alimama_union_product_price_chartEntity
 * @author YHQ
 * @version 2023-07-15
 */
@Table(name="maoche_alimama_union_product_price_chart", alias="a", label="maoche_alimama_union_product_price_chart信息", columns={
...
public class MaocheAlimamaUnionProductPriceChartDO extends DataEntity<MaocheAlimamaUnionProductPriceChartDO> {
	...
	public MaocheAlimamaUnionProductPriceChartDO() {
		this(null);
	}
	
	public MaocheAlimamaUnionProductPriceChartDO(String id){
		super(id);
	}
