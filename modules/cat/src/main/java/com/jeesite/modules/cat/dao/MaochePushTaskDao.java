...
public interface MaochePushTaskDao extends CrudDao<MaochePushTaskDO> {
    ...
    List<MaochePushTaskDO> getByIds(@Param("ids") List<String> ids);
    ...
    /**
     * 获取推送任务id，id > ? limit ? order by id asc
     * @param id
     * @param limit
     * @return
     */
    List<String> getIds(@Param(value = "id") String id, @Param(value = "limit") int limit);
